...
import { financeCaluculations } from "../utils/financeCaluculations";
...
const MonthlySummary = ({monthlyTaransactions,setCurrentMonth}: MonthlySummaryProps) => {
const {income,expense,balance}= financeCaluculations(monthlyTaransactions)  
